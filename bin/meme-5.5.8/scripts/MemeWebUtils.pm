...
use lib qw(/home/ama55id/rnaanalyzer/bin/meme-5.5.8/lib/meme-5.5.8/perl);
...
unless ($@) {
  Log::Log4perl::init('/home/ama55id/rnaanalyzer/bin/meme-5.5.8/share/meme-5.5.8/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/home/ama55id/rnaanalyzer/bin/meme-5.5.8/var/meme-5.5.8/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/home/ama55id/rnaanalyzer/bin/meme-5.5.8/share/meme-5.5.8/job_status.tmpl');
