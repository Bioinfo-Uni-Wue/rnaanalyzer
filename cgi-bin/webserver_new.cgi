...
$VIENNAFOLDDIR='../ViennaRNA-2.4.18/src/Utils'; #pointing to the the Program Fold of the Vienna package
$VIENNARNAFOLDDIR='../bin/ViennaRNA-2.4.18/src/bin'; #pointing to the RNAfold dir
$MAXFOLDINGLEN=1500;
