#!/usr/bin/perl -I /mnt/c/Users/ama55id/Nextcloud/RNA_analyzer/rnaanalyzer/cgi-bin/
...
#Dir-Localisations
$TEMPPICSDIR='/mnt/c/Users/ama55id/Nextcloud/RNA_analyzer/rnaanalyzer/session/';
...
sub runAnDom {
    ...
    print '<a target="_blank" href="./export_result_to_andom_new.cgi?'.$predprotforAnDom;
...
##### Creating a unique id using md5sum
        ...
        $andomtemp="indexandom_new$job"."_"."$md5andom".".html";
	`cp /mnt/c/Users/ama55id/Nextcloud/RNA_analyzer/rnaanalyzer/htdocs/indexandom_new.html /mnt/c/Users/ama55id/Nextcloud/RNA_analyzer/rnaanalyzer/tmp/$andomtemp`;
	...
	print '<a target="_blank" href="'."/cgi-bin/get_result_andom_new.pl?"."$andomtemp".'">Directly Analyze the predicted Protein using AnDom</a><br>';
